...
import cn.modificator.fadelauncher.util.ConfigMonitor;
import cn.modificator.fadelauncher.util.Preconditions;
import cn.modificator.fadelauncher.util.SettingsObserver;

import java.util.concurrent.Callable;
import java.util.concurrent.ExecutionException;

import static cn.modificator.fadelauncher.SettingsActivity.NOTIFICATION_BADGING;
