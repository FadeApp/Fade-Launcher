...
import cn.modificator.fadelauncher.CellLayout.ContainerType;
import cn.modificator.fadelauncher.badge.BadgeRenderer;
import cn.modificator.fadelauncher.config.FeatureFlags;
import cn.modificator.fadelauncher.graphics.IconNormalizer;
    ...
    public DeviceProfile(Context context, InvariantDeviceProfile inv,
        ...
        if (!isVerticalBarLayout() && isPhone && isTallDevice) {
            ...
            int extraSpace = getCellSize().y - iconSizePx - iconDrawablePaddingPx * 2
                    - res.getDimensionPixelSize(R.dimen.dynamic_grid_hotseat_tall_remove_space);
