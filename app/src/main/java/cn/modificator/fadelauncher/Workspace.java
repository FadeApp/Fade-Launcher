...
import cn.modificator.fadelauncher.Launcher.LauncherOverlay;
import cn.modificator.fadelauncher.LauncherAppWidgetHost.ProviderChangedListener;
import cn.modificator.fadelauncher.LauncherStateManager.AnimationConfig;
import cn.modificator.fadelauncher.accessibility.AccessibleDragListenerAdapter;
import cn.modificator.fadelauncher.accessibility.WorkspaceAccessibilityHelper;
import cn.modificator.fadelauncher.anim.AnimatorSetBuilder;
import cn.modificator.fadelauncher.anim.Interpolators;
import cn.modificator.fadelauncher.badge.FolderBadgeInfo;
...
import cn.modificator.fadelauncher.dragndrop.DragOptions;
import cn.modificator.fadelauncher.dragndrop.DragView;
import cn.modificator.fadelauncher.dragndrop.SpringLoadedDragController;
import cn.modificator.fadelauncher.folder.Folder;
import cn.modificator.fadelauncher.folder.FolderIcon;
import cn.modificator.fadelauncher.folder.PreviewBackground;
import cn.modificator.fadelauncher.graphics.DragPreviewProvider;
import cn.modificator.fadelauncher.graphics.PreloadIconDrawable;
import cn.modificator.fadelauncher.pageindicators.WorkspacePageIndicator;
import cn.modificator.fadelauncher.popup.PopupContainerWithArrow;
import cn.modificator.fadelauncher.shortcuts.ShortcutDragPreviewProvider;
import cn.modificator.fadelauncher.touch.ItemLongClickListener;
import cn.modificator.fadelauncher.touch.WorkspaceTouchListener;
...
import cn.modificator.fadelauncher.util.LongArrayMap;
import cn.modificator.fadelauncher.util.PackageUserKey;
import cn.modificator.fadelauncher.util.Thunk;
import cn.modificator.fadelauncher.util.WallpaperOffsetInterpolator;
...
import static cn.modificator.fadelauncher.LauncherAnimUtils.SPRING_LOADED_TRANSITION_MS;
...
import static cn.modificator.fadelauncher.LauncherState.SPRING_LOADED;
import static cn.modificator.fadelauncher.dragndrop.DragLayer.ALPHA_INDEX_OVERLAY;
...
public class Workspace extends CircularSlidePagedView<WorkspacePageIndicator>
    ...
    public void setInsets(Rect insets) {
        ...
        mMaxDistanceForFolderCreation = grid.isTablet
                ? 0.85f * grid.iconSizePx
                : 0.65f * grid.iconSizePx;
...
//                    float alpha = 1 - Math.abs(scrollProgress);
   ...
   void mapPointFromSelfToHotseatLayout(Hotseat hotseat, float[] xy) {
    ...
    public Bitmap createWidgetBitmap(ItemInfo widgetInfo, View layout) {
        ...
        int width = View.MeasureSpec.makeMeasureSpec(unScaledSize[0], View.MeasureSpec.EXACTLY);
        int height = View.MeasureSpec.makeMeasureSpec(unScaledSize[1], View.MeasureSpec.EXACTLY);
