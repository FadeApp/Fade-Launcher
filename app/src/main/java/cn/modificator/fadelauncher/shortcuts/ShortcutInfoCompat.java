 ...
 *
 * Not to be confused with {@link cn.modificator.fadelauncher.ShortcutInfo}.
 */
@TargetApi(Build.VERSION_CODES.N)
public class ShortcutInfoCompat {
    private static final String INTENT_CATEGORY = "cn.modificator.fadelauncher.DEEP_SHORTCUT";
