...
package cn.modificator.fadelauncher.shortcuts;
...
public class DeepShortcutManager {
    ...
    public static boolean supportsShortcuts(ItemInfo info) {
        boolean isItemPromise = info instanceof cn.modificator.fadelauncher.ShortcutInfo
                && ((cn.modificator.fadelauncher.ShortcutInfo) info).hasPromiseIconUi();
