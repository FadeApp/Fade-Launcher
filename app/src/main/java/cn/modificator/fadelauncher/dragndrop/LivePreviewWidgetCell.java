...
public class LivePreviewWidgetCell extends WidgetCell {
     ...
     * @see cn.modificator.fadelauncher.WidgetPreviewLoader#generateWidgetPreview
     *
    ...
    public static Bitmap generateFromRemoteViews(BaseActivity activity, RemoteViews views,
        ...
        try {
            ...
            v.measure(View.MeasureSpec.makeMeasureSpec(viewWidth, View.MeasureSpec.EXACTLY),
