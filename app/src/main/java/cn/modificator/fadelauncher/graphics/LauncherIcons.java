...
package cn.modificator.fadelauncher.graphics;
...
import cn.modificator.fadelauncher.model.PackageItemInfo;
...
import static cn.modificator.fadelauncher.graphics.ShadowGenerator.BLUR_FACTOR;
...
public class LauncherIcons implements AutoCloseable {
    ...
    private Drawable normalizeAndWrapToAdaptiveIcon(Drawable icon, int iconAppTargetSdk,
        ...
        float scale = 1f;
        if (Utilities.ATLEAST_OREO && FeatureFlags.FORCE_ADAPTIVE_ICONS) {
            ...
            if (!outShape[0] && !(icon instanceof AdaptiveIconDrawable)) {
