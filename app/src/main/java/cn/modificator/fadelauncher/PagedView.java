...
import cn.modificator.fadelauncher.pageindicators.PageIndicator;
import cn.modificator.fadelauncher.touch.OverScroll;
import cn.modificator.fadelauncher.util.Thunk;

import java.util.ArrayList;

import static cn.modificator.fadelauncher.compat.AccessibilityManagerCompat.isAccessibilityEnabled;
import static cn.modificator.fadelauncher.compat.AccessibilityManagerCompat.isObservedEventType;
            ...
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                if (!mFreeScroll) {
                    ...
                    if (((isSignificantMove && !isDeltaXLeft && !isFling) ||
                            (isFling && !isVelocityXLeft)) && mCurrentPage > getMinPageIndex()) {
...
//    protected abstract boolean isPagedViewCircledScroll();
    protected boolean isPagedViewCircledScroll(){
        return FeatureFlags.WORKSPACE_SCROLL_CIRCULAR;
    };
}
